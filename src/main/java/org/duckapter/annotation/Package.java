...
/**
 * Denotes that the target elements must declare default "package" visibility.
 * The desired visibility can be more flexible using the {@link #value()}.
 * Can be used on the duck interfaces and on the duck methods. 
